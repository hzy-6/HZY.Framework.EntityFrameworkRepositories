...
namespace HZY.Framework.EntityFrameworkRepositories.Interceptor
{
    ...
    public class MonitorDbCommandInterceptor : DbCommandInterceptor
    {
        ...
        {
            EntityFrameworkRepositoriesMonitorCache.CreateCommandCount();
        ...
        {
            EntityFrameworkRepositoriesMonitorCache.CommandFailedCount();
            //记录 api 执行耗时
            _stopwatch.Stop();
            EntityFrameworkRepositoriesMonitorCache.SetSqlInfo(command, _stopwatch.ElapsedMilliseconds);
        ...
        {
            EntityFrameworkRepositoriesMonitorCache.ExecuteCommandCount();
            //记录 api 执行耗时
            _stopwatch.Stop();
            EntityFrameworkRepositoriesMonitorCache.SetSqlInfo(command, _stopwatch.ElapsedMilliseconds);
