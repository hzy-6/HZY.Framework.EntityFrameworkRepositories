...
namespace HzyEFCoreRepositories.Repositories.Impl
{
    ...
    /// </summary>
    /// <typeparam name="T"></typeparam>
    public class AppRepositoryImpl<T> : RepositoryBaseImpl<T>, IRepository<T>
        where T : class, new()
    {
        /// <summary>
        /// 基础仓储
        ...
        public AppRepositoryImpl(Expression<Func<T, bool>> filter = null)
            : base(HzyEFCoreUtil.CreateScope().ServiceProvider.GetService(HzyEFCoreUtil.GetDbContextType(typeof(T).FullName)), filter)
        {
        ...
        /// <param name="filter"></param>
        /// <returns></returns>
        public virtual IRepository<T> AddQueryFilter(Expression<Func<T, bool>> filter = null)
        {
            this._filter = filter;
            return this;
        }
        ...
        /// </summary>
        /// <returns></returns>
        public virtual IRepository<T> IgnoreQueryFilter()
        {
            isIgnoreQueryFilter = true;
            return this;
        }
        ...
        /// </summary>
        /// <returns></returns>
        public virtual IRepository<T> RecoveryQueryFilter()
        {
            isIgnoreQueryFilter = false;
            return this;
        }
