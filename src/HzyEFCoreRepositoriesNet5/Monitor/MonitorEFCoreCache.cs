...
namespace HzyEFCoreRepositories.Monitor
{
    /// <summary>
    /// 监控EFCore缓存
    /// </summary>
    public static class MonitorEFCoreCache
    {
        private readonly static IMemoryCache _memoryCache;
        private readonly static EFCoreMonitorContext _eFCoreMonitorContext;
        private readonly static string EFCoreMonitorContextCacheKey = "EFCoreMonitorContext";
        private readonly static List<EFCoreMonitorSqlContext> _eFCoreMonitorSqlContextList;
        ...
        static MonitorEFCoreCache()
        {
            if (_memoryCache == null)
            {
                var memoryCacheOptions = new MemoryCacheOptions();
                _memoryCache = new MemoryCache(memoryCacheOptions);
                _memoryCache.Set(EFCoreMonitorContextCacheKey, new EFCoreMonitorContext(), DateTime.Now.AddDays(time));
                _memoryCache.Set(EFCoreMonitorSqlContextListCacheKey, new List<EFCoreMonitorSqlContext>(), DateTime.Now.AddDays(time));
            }

            _eFCoreMonitorContext = _memoryCache.Get<EFCoreMonitorContext>(EFCoreMonitorContextCacheKey);
            _eFCoreMonitorSqlContextList = _memoryCache.Get<List<EFCoreMonitorSqlContext>>(EFCoreMonitorSqlContextListCacheKey);
        ...
        /// efcore 监控上下文
        /// </summary>
        public static EFCoreMonitorContext Context => _eFCoreMonitorContext;

        /// <summary>
        /// sql 监控上下文
        /// </summary>
        public static List<EFCoreMonitorSqlContext> SqlContext => _eFCoreMonitorSqlContextList;
        ...
        {
            _eFCoreMonitorSqlContextList.Add(new EFCoreMonitorSqlContext { Sql = dbCommand.CommandText, ElapsedMilliseconds = ElapsedMilliseconds });
        }
